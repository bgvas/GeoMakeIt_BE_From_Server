...
<head>
    ...
    <!-- Fonts -->
    <link rel="stylesheet" type="text/css" href="{{ url('registration_form/css/roboto-font.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ url('registration_form/fonts/line-awesome/css/line-awesome.min.css') }}">

    <!-- Styles -->
    <link rel="stylesheet" href="{{ url('registration_form/css/style.css') }}"/>
